; Listing generated by Microsoft (R) Optimizing Compiler Version 19.41.34120.0 
	...
	TITLE	F:\projects\STM32\STM32F411E-Disco\SPI_Display\SPI_Display\TouchGFX\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1PI@KLONPAMO@?$AAF?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AAs?$AA?2?$AAS?$AAT?$AAM@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1PI@KLONPAMO@?$AAF?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AAs?$AA?2?$AAS?$AAT?$AAM@
CONST	SEGMENT
??_C@_1PI@KLONPAMO@?$AAF?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AAs?$AA?2?$AAS?$AAT?$AAM@ DB 'F'
...
; _this$ = ecx
; File F:\projects\STM32\STM32F411E-Disco\SPI_Display\SPI_Display\TouchGFX\generated\fonts\include\fonts\CachedFont.hpp
; Line 82
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __409866DD_CachedFont@hpp
...
; _this$ = ecx
; File F:\projects\STM32\STM32F411E-Disco\SPI_Display\SPI_Display\TouchGFX\generated\fonts\include\fonts\FontCache.hpp
; Line 76
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __599293C4_FontCache@hpp
	call	@__CheckForDebuggerJustMyCode@4
	npad	1
; Line 77
	mov	eax, DWORD PTR _this$[ebp]
...
; _this$ = ecx
; File F:\projects\STM32\STM32F411E-Disco\SPI_Display\SPI_Display\TouchGFX\generated\fonts\src\FontCache.cpp
; Line 418
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __DF4C6518_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
	npad	1
; Line 419
	mov	eax, DWORD PTR _this$[ebp]
...
$LN3@getTextDir:
	mov	esi, esp
	push	144					; 00000090H
	push	OFFSET ??_C@_1PI@KLONPAMO@?$AAF?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAj?$AAe?$AAc?$AAt?$AAs?$AA?2?$AAS?$AAT?$AAM@
